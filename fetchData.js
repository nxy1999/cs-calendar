 ...
 */
async function fetchMatchesData(eventIds, type, func) {
  let result
  switch (func) {
    case "getResults":
      ...
      break
    case "getMatches":
      result = await HLTV.getMatches({ eventIds, filter: type })
      break
    default:
 ...
 */
async function fetchAndProcessData(eventIds, filter, funcName) {
